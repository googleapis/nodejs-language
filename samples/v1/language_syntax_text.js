...
//   usage: node samples/v1/language_syntax_text.js [--text_content "This is a short sentence."]

'use strict';

function main(textContent = 'This is a short sentence.') {
...
const argv = require(`yargs`).option('text_content', {
  default: 'This is a short sentence.',
  string: true,
}).argv;
