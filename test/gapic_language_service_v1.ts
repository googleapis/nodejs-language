...
describe('v1.LanguageServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = languageserviceModule.v1.LanguageServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = languageserviceModule.v1.LanguageServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('analyzeSentiment', () => {
        it('invokes analyzeSentiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.language.v1.AnalyzeSentimentRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.language.v1.AnalyzeSentimentResponse());
        ...
        it('invokes analyzeSentiment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.analyzeSentiment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v1.IAnalyzeSentimentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes analyzeSentiment with error', async () => {
            ...
            assert.rejects(async () => { await client.analyzeSentiment(request); }, expectedError);
            assert((client.innerApiCalls.analyzeSentiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('analyzeEntities', () => {
        it('invokes analyzeEntities without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.language.v1.AnalyzeEntitiesRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.language.v1.AnalyzeEntitiesResponse());
        ...
        it('invokes analyzeEntities without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.analyzeEntities(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v1.IAnalyzeEntitiesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes analyzeEntities with error', async () => {
            ...
            assert.rejects(async () => { await client.analyzeEntities(request); }, expectedError);
            assert((client.innerApiCalls.analyzeEntities as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('analyzeEntitySentiment', () => {
        it('invokes analyzeEntitySentiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.language.v1.AnalyzeEntitySentimentRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.language.v1.AnalyzeEntitySentimentResponse());
        ...
        it('invokes analyzeEntitySentiment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.analyzeEntitySentiment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v1.IAnalyzeEntitySentimentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes analyzeEntitySentiment with error', async () => {
            ...
            assert.rejects(async () => { await client.analyzeEntitySentiment(request); }, expectedError);
            assert((client.innerApiCalls.analyzeEntitySentiment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('analyzeSyntax', () => {
        it('invokes analyzeSyntax without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.language.v1.AnalyzeSyntaxRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.language.v1.AnalyzeSyntaxResponse());
        ...
        it('invokes analyzeSyntax without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.analyzeSyntax(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v1.IAnalyzeSyntaxResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes analyzeSyntax with error', async () => {
            ...
            assert.rejects(async () => { await client.analyzeSyntax(request); }, expectedError);
            assert((client.innerApiCalls.analyzeSyntax as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('classifyText', () => {
        it('invokes classifyText without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.language.v1.ClassifyTextRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.language.v1.ClassifyTextResponse());
        ...
        it('invokes classifyText without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.classifyText(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v1.IClassifyTextResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes classifyText with error', async () => {
            ...
            assert.rejects(async () => { await client.classifyText(request); }, expectedError);
            assert((client.innerApiCalls.classifyText as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('annotateText', () => {
        it('invokes annotateText without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.language.v1.AnnotateTextResponse());
        ...
        it('invokes annotateText without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.annotateText(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.language.v1.IAnnotateTextResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes annotateText with error', async () => {
            ...
            assert.rejects(async () => { await client.annotateText(request); }, expectedError);
            assert((client.innerApiCalls.annotateText as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
